...
public final class CaseServiceMockStub implements CTPEndpoint {
    ...
    @Autowired
    private CasesConfig casesConfig; // can allow field injection here in a mock service.
    @Autowired
    private QuestionnairesConfig questionnairesConfig;
    ...
    public ResponseEntity<ResponseDTO> addCaseData(
    ...
    /**
     * Post a list of Questionnaires in order to add to the questionnaire maps driving the responses here.
     *
    ...
    public ResponseEntity<ResponseDTO> resetQuestionnaireData() throws CTPException {
        try {
            ...
            throw new CTPException(
                    CTPException.Fault.BAD_REQUEST, "Unable to reset Questionnaire Data - IO Exception  reading JSON");
        }
    }
